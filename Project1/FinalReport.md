...
1 개발항목
	...
	<img width="259" alt="savefilecontents" src="https://user-images.githubusercontent.com/103713510/190851217-207927a8-e078-4d97-8645-f92fc4539bf0.png">

2 ~~프로그램을 실행하면 이미 저장된 데이터 파일을 열어 데이터를 읽어온 후, 이 데이터를 기반으로 단어 관리를 수행. [7.파일저장]을 통해 업데이트.~~
3 ~~검색기능 구현 [2.수준별 단어보기 / 3.단어검색]~~
