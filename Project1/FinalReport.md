...
> 위 모든 실행 화면 캡쳐 이미지를 github에 올리고, README.md에 연결했습니다.
> : https://github.com/LeeMineo/22-2-PP/blob/master/README.md
...
> 저번학기에 자바를 배우고 난 후 처음으로 프로젝트를 하게 되었다. 확실히 내가 자바에 대해 자세히 모른다는것을 느꼈고 이번 프로젝트를 통해 공부를 더 해야겠다는 생각이 들었다. 또한 앞으로의 프로젝트도 매우 기대가 된다. 
